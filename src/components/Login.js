...
const Login = () => {
  ...
  const handleButtonClick = (event) => {
    ...
    const errorMsg = validateFields(email.current.value, password.current.value)
  ...
  return (
    <div>
      ...
      <div className="absolute">
        <img
          className="h-screen w-screen object-cover bg-gradient-to-tr from-black  to-red-500"
          src={NETFLIX_BG}
          alt="background"
        />
      </div>
