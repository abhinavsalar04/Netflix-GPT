...
const VideoTitle = ({ title, overview, movieId }) => {
  ...
  return (
    <div className="pt-[40%] pl-6 w-screen aspect-video md:pt-[15%]  md:px-12 lg:mb-24 absolute text-white bg-gradient-to-r from-gray-950">
      <h1 className="text-lg md:text-4xl lg:text-5xl  font-bold  md:m-0">
        {title}
      </h1>
      <p className="hidden md:inline-block lg:text-lg md:text-[100%] md:py-6 md:w-[70%]">
        {overview}
      </p>
      <div className="mt-[4px] md:m-0">
        <button className="hidden md:inline-block bg-white text-black md:p-[.25rem] md:px-[1.3rem] p-[.15rem] px-[.85rem] rounded-[3px] hover:bg-opacity-80 md:text-md text-sm cursor-pointer">
