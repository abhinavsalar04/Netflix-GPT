    ...
    <footer className=" py-[50px] w-full text-white  bg-black">
      <div className="flex items-center flex-col">
        <ul className="list-none flex items-center justify-center gap-[15px] mb-[20px]">
          <li className="cursor-pointer text-[12px] transition-all ease duration-300 hover:text-red-600">
            Terms Of Use
          </li>
          <li className="cursor-pointer text-[12px] transition-all ease duration-300 hover:text-red-600">
            Privacy-Policy
        ...
        <div className="text-[12px] opacity-50 text-center max-w-[800px] mb-[2px]">
          ...
          project for non-commercial use. No copyright or trademark infringement
          is intended, and I will not utilize this project for business purpose.
        </div>
